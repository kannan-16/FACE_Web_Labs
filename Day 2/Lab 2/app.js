...
let captainData = ["Ashley Young", 34, 2011, "Manchester Utd", "Defender", "England"];
...
function SortByNamexOlderThan(age) {
    ...
    for(let i=0;i<players.length;i++)
    {
        ...
        {
            filteredArray[count] = players[i];
            filteredArray[count].awards = SortAwardsByYear(filteredArray[count].awards);
            count++;
        }
    }
    return SortByPlayerName(filteredArray);
